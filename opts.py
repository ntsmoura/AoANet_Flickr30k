...
def parse_opt():
    ...
    parser.add_argument(
        ...
        default="show_tell",
        help=(
            "show_tell, show_attend_tell, all_img, fc, att2in, att2in2, att2all2, adaatt, adaattmo, topdown, stackatt,"
            " denseatt, transformer"
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=0,
        help=(
            "If 1, then do batch_normalization first in att_embed, if 2 then do bn both in the beginning and the end of"
            " att_embed"
        ),
    )
    ...
    parser.add_argument(
        ...
        default=2,
        help=(
            "use multi head attention? 0 for addictive single head; 1 for addictive multi head; 2 for productive multi"
            " head."
        ),
    )
    ...
    parser.add_argument(
        ...
        default=5,
        help=(
            "number of captions to sample for each image during training. Done for efficiency since CNN forward pass is"
    ...
    parser.add_argument(
        ...
        default=1,
        help=(
            "used when sample_method = greedy, indicates number of beams in beam search. Usually 2 or 3 works well."
    ...
    parser.add_argument(
        ...
        default=0,
        help=(
            "Evaluate language as well (1 = yes, 0 = no)? BLEU/CIDEr/METEOR/ROUGE_L? requires coco-caption code from"
            " Github."
        ),
    )
    parser.add_argument(
...
def add_eval_options(parser):
    ...
    parser.add_argument(
        ...
        default=2,
        help=(
            "indicates number of beams in beam search. Usually 2 or 3 works well. More is not better. Set this to 1 for"
    ...
    parser.add_argument(
        ...
        default=0.5,
        help=(
            "used for diverse beam search. Usually from 0.2 to 0.8. Higher value of lambda produces a more diverse list"
        ),
    )
    parser.add_argument(
        "--temperature",
        ...
        default=1.0,
        help=(
            'temperature when sampling from distributions (i.e. when sample_method = sample). Lower = "safer"'
            " predictions."
        ),
    )
    ...
    parser.add_argument(
        ...
        default="",
        help=(
            "if nonempty then use this file in DataLoaderRaw (see docs there). Used only in MSCOCO test evaluation,"
